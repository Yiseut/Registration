...
def build_record_card(row: dict) -> dict:
    ...
    return {
        ...
        "record_type": safe_strip(row.get("record_type")),
        "regulatory_class": safe_strip(row.get("regulatory_class")),
        "device_type": safe_strip(row.get("device_type")),
        ...
        "validity_status": safe_strip(row.get("validity_status")),
