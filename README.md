...
- HA 利多卡因分析以官方注册证名称/产品名为准：中文“利多卡因”或英文 `Lidocaine` 均直接计入“含利多卡因”，不再拆“严格/候选”口径；当前 91 张交联填充剂中含利多卡因 24 张、未见利多卡因 67 张。
...
- smoke test 必须检查主表行数、集中度表、Dysport `S20200016`、HA 韩国进口含利多卡因视图、自定义透视页默认 91 张和拖拽列变量、详情抽屉、无旧 `codex-data.js`、移动端无横向溢出和 8 个赛道页加载。
