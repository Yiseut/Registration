...
const palette = {
  ...
  bg: '#f3f1f1',
  surface: '#f8f4f4',
  rose: '#cf6a9d', plum: '#b486d4', gold: '#e5b574',
  sage: '#dd7b8b', ocean: '#58bfd7', slate: '#737ed0', clay: '#e5b574',
  periwinkle: '#9daaf0', cream: '#f8ead7',
};

// Ordered palette used for series colors
const SERIES_COLORS = [
  '#58bfd7', '#737ed0', '#dd7b8b', '#9daaf0',
  '#e5b574', '#b486d4', '#cf6a9d', '#8fa8c8',
  '#f4dbe8', '#dff4f8', '#786868', '#b3b3b3',
];
